  ...
  return (
      ...
      <header ref={headerRef}
          ...
          <div className="container  flex justify-between items-center gap-[30px] sm:gap-0 flex-col sm:flex-row">
              ...
              <img src="/src/assets/images/logo.svg" alt="logo-img"></img>
          ...
          <nav>
              <ul className="flex items-center gap-[50px]">
                  ...
                  {links.map((link) => (
                      ...
                      <li key={link}>
                          <a href={`/${link.toLowerCase()}`} className="text-white opacity-[0.9] hover:opacity-[1] hover:underline transition-opacity duration-200 "
